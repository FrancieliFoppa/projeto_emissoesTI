...
public class ConnectionBD{
    ...
    private String nomeDoBanco = "bdem";
    private String usuario = "root";
    private String senha = "passROOT";
    
    public ConnectionBD(){}
    
    public ConnectionBD(String pServidor, String pNomeDoBanco, String pUsuario, String pSenha){
     ...
     */
    public Connection conectar() throws InstantiationException, IllegalAccessException, ClassNotFoundException{
        try {
            //Driver do Mysql
